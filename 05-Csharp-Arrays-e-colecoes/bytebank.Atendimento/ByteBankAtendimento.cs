using _05_Csharp_Arrays_e_colecoes.bytebank.Modelos.Conta;
using _05_Csharp_Arrays_e_colecoes.bytebank.Exceptions;

namespace _05_Csharp_Arrays_e_colecoes.bytebank.Atendimento
{
    #nullable disable
